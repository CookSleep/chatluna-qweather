...
var QueryTypeSchema = Schema.union([
...
var Config = Schema.intersect([
  Schema.object({
    tool: Schema.object({
      ...
      description: Schema.string().default("查询天气，输入城市名、LocationID 或经纬度，返回城市匹配、天气预报、分钟级降水或空气质量。").description("工具描述")
    }).description("工具设置")
  }),
  Schema.object({
...
// src/index.ts
var querySchema = z.enum(["weatherNow", "weatherDaily", "weatherHourly", "minutelyPrecipitation", "airCurrent", "airHourly", "airDaily"]);
var schema = z.object({
...
var QWeatherTool = class extends StructuredTool {
  constructor(ctx, cfg) {
    super({});
    this.ctx = ctx;
    this.cfg = cfg;
